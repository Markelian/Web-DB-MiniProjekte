    ...
    <form action="update_produkt.php" method="post" onsubmit="return validoProduktin();">
        ...
        <div>
            ...
            <select id="kategoria" name="kategoria" required>
                ...
                <option value="Prodhime Deti"   <?= $produkt['kategoria']==='Prodhime Deti'   ? 'selected' : '' ?>>Prodhime Deti</option>
                <option value="kancelari"   <?= $produkt['kategoria']==='Kancelari'   ? 'selected' : '' ?>>Kancelari</option>
                <option value="Orendi"   <?= $produkt['kategoria']==='Orendi'   ? 'selected' : '' ?>>Orendi</option>
                <option value="Veshje"   <?= $produkt['kategoria']==='Veshje'   ? 'selected' : '' ?>>Veshje</option>
                <option value="Argjendari"     <?= $produkt['kategoria']==='Argjendari'     ? 'selected' : '' ?>>Argjendari</option>
                <option value="Suvenire"     <?= $produkt['kategoria']==='Suvenire'     ? 'selected' : '' ?>>Suvenire</option>
                <option value="Vegla Pune"     <?= $produkt['kategoria']==='Vegla Pune'     ? 'selected' : '' ?>>Vegla Pune</option>
                <option value="Tjeter"     <?= $produkt['kategoria']==='Tjeter'     ? 'selected' : '' ?>>Tjeter</option>
            </select>
        </div>
